    ...
    <div class="w-full max-w-3xl bg-white/80 backdrop-blur-xl shadow-2xl rounded-3xl p-6 md:p-10 border border-white/50">
      ...
      <ul v-else class="space-y-4">
        <li 
          ...
          :class="habit.completed ? 'bg-indigo-50/60 border border-indigo-100/50 opacity-80' : 'bg-white shadow-md border border-gray-100'"
          @click="toggleHabit(habit.id)"
        >
          <div 
            class="w-10 h-10 rounded-full flex items-center justify-center shrink-0 transition-all duration-300 border-2"
            :class="habit.completed ? 'bg-green-500 border-green-500 text-white scale-110 shadow-lg shadow-green-200' : 'bg-gray-50 border-gray-300 text-transparent group-hover:border-indigo-400 group-hover:bg-indigo-50'"
          >
          ...
          <span 
            ...
            :class="habit.completed ? 'text-gray-400 line-through decoration-gray-400/50 decoration-2' : 'text-gray-700'"
          >
            {{ habit.title }}
          </span>
